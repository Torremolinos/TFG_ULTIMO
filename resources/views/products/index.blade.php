                ...
                <li class="cards_item">
                    <div class="card">
                        ...
                        <div class="card_content">
                            ...
                            @auth
                            <button class="btn card_btn add-to-cart" data-id="{{ $product->id }}"
                                data-name="{{ $product->name }}" data-price="{{ $product->price }}">Comprar</button>
                            @else
                            <p>Por favor, <a href="{{ route('login') }}">inicia sesión</a> o <a
                                    href="{{ route('register') }}">regístrate</a> para poder comprar.</p>
                            @endauth
                        </div>
                    </div>
                </li>
