            ...
            <ul class="cards">
                <li class="cards_item">
                    <div class="card">
                        ...
                        <div class="card_content">
                            ...
                            <p class="card_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam odit
                                expedita, quia assumenda sint cupiditate a saepe laborum molestias iure, blanditiis
                                minus. Culpa aliquid nam voluptate quos assumenda enim temporibus.</p>
                ...
                <li class="cards_item">
                    <div class="card">
                        ...
                        <div class="card_content">
                            <h2 class="card_title">Card Grid Layout</h2>
                            <p class="card_text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
                                itaque consectetur esse quod tempora! Numquam corporis sapiente aliquid quidem
                                provident! Porro iste ipsa blanditiis error in odit maiores, provident cupiditate?</p>
                            <button class="btn card_btn">Comprar</button>
                        </div>
                    </div>
                </li>
